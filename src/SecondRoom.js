...
import secondroomimg1 from "./image/secondroom1.jpg";
import secondroomimg2 from "./image/secondroom2.jpg";
import secondroomimg3 from "./image/secondroom3.jpg";
import secondroomimg4 from "./image/secondroom4.jpg";
import secondroomimg5 from "./image/secondroom5.jpg";
import secondroomimg6 from "./image/secondroom6.jpg";
import Navbarpg from "./Navbarpg";
import Logo from "./Logo";
import { Helmet } from "react-helmet";
import sevenstarroomimg from "./image/7star_room.jpg";
...
const SecondRoom = () => {
  ...
  const [amountroomType] = useState("7star room");
  ...
  const paydata = () => {
    axios
      .post(`http://localhost:1001/router/second_room_pay_amount`, {
        email: amountemail,
  ...
  const submitamountdata = () => {
    axios
      .post(`http://localhost:1001/router/second_room`, {
        email: amountemail,
        person: amountperson,
        roomNo: key,
  ...
  return (
    ...
    >
      ...
      <Modal show={show2} onHide={handleClose2}>
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>room no:{key} || 7star room</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div
              class="card"
