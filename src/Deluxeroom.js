...
import roomimg1 from "./image/deluxe1.jpg";
import roomimg2 from "./image/deluxe2.jpg";
import roomimg3 from "./image/deluxe3.jpg";
import roomimg4 from "./image/deluxe4.jpg";
import roomimg5 from "./image/deluxe5.jpg";
import roomimg6 from "./image/deluxe6.jpg";
import Navbarpg from "./Navbarpg";
import Logo from "./Logo";
import { Helmet } from "react-helmet";
import deluxeroomimg from "./image/deluxe_room.jpg";

const Deluxeroom = () => {
  const arr = [roomimg1, roomimg2, roomimg3, roomimg4, roomimg5, roomimg6];
  ...
  const [amountroomType] = useState("Deluxe Room");
  ...
  const paydata = () => {
    axios
      .post(`http://localhost:1001/router/deluxe_pay_amount`, {
        email: amountemail,
  ...
  const submitamountdata = () => {
    axios
      .post(`http://localhost:1001/router/dlroom_register`, {
        email: amountemail,
        person: amountperson,
        roomNo: key,
        roomType: amountroomType,
  ...
  return (
    ...
    >
          ...
          <div className="col">
            <div className="card shadow-sm">
              <rect width="100%" height="100%" fill="#55595c">
                <img src={item} alt="wrong" width="100%" height="210" />
              </rect>
              <div
                className="card-body"
                style={{
      ...
      <Modal show={show2} onHide={handleClose2}>
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>room no:{key} || Deluxe Room</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div
              class="card"
