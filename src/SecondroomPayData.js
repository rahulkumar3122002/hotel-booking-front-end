...
const SecondroomPayData = () => {
  ...
  const second_room_data = () => {
    axios
      .get(`http://localhost:1001/router/second_room_data`)
      .then((result) => {
        console.log("result.....", result);
        setSecondRoomAllData(result.data.message);
      })
      .catch((error) => {
  ...
  const delete_second_room_user_data = (_id) => {
    axios
      .delete(`http://localhost:1001/router/delete_second_room_data/${_id}`)
      .then((result) => {
        console.log("result.....", result);
        handleClose();
        second_room_data();
...
export default SecondroomPayData;
